"""
Spaceship Titanic - Stacking Ensemble
======================================
3-Model Stacking: LightGBM + XGBoost + CatBoost
Meta-Learner: Logistic Regression

Target: 81.5%+ accuracy
"""
...
features = [
    ...
    'TotalSpending', 'HasSpending', 'SpendingPerAge',
    'GroupId', 'PersonInGroup', 'GroupSize', 'IsAlone',
    'Deck', 'CabinNum', 'Side', 'FamilySize', 'AgeGroup'
]
...
# Meta-learner CV (on training data)
...
print(f"Saved submission_stacking.csv with {len(submission)} predictions")
