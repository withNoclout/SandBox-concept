"""
Spaceship Titanic - Tuned 4-Model Stacking
===========================================
Using user-provided best parameters for CatBoost and LightGBM

Kaggle Progress: 0.801 -> 0.804 -> 0.806 -> Target: 0.81+
"""
...
# ============================================================
# TUNED PARAMETERS (User-provided)
# ============================================================
print("\n⚙️ Using TUNED Parameters...")

# LightGBM - Best from user's grid search
lgb_params = {
    'objective': 'binary',
...
print(f"LightGBM: lr={lgb_params['learning_rate']}, depth={lgb_params['max_depth']}, leaves={lgb_params['num_leaves']}")
print(f"CatBoost: lr={cat_params['learning_rate']:.4f}, depth={cat_params['depth']}, l2={cat_params['l2_leaf_reg']:.2f}")

# ============================================================
# TUNED 4-MODEL STACKING
# ============================================================
print("\n🚀 Training TUNED 4-Model Stacking Ensemble...")
...
print(f"LightGBM CV (TUNED): {lgb_cv:.4f}")
print(f"XGBoost CV (TUNED):  {xgb_cv:.4f}")
print(f"CatBoost CV (TUNED): {cat_cv:.4f}")
print(f"HistGradientBoost:   {hgb_cv:.4f}")
print(f"Simple Avg (4):      {avg_cv:.4f}")
...
print(f"Saved submission_tuned.csv with {len(submission)} predictions")
